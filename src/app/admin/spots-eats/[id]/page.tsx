...
export default function EditSpotPage() {
      ...
      try {
        ...
        if (item && !cancelled) {
          setForm({
            ...
            location: item.location || "", category: item.category || "spot",
            coverImage: item.coverImage || "", tags: item.tags || [],
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/admin/spots/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(form) });
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div><h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white">Edit Spot</h1></div>
      </div>
