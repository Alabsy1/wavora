...
/**
 * Scene 03 — CHOOSE YOUR WAY.
 * One interactive editorial index: the list drives one dominant visual.
 * Hover / focus / tap all set the active way; the CTA lives in the visual.
 */
export function SeaWaysIndex() {
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-6 p-6 sm:p-7">
                ...
                <Link
                  ...
                  aria-label={`${way.label} — ${way.description}`}
                >
                  <ArrowUpRight
